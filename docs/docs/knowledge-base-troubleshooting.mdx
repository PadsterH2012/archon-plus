...
**In Progress**:
- [ ] Systematic search for remaining old HTTPException source
- [ ] Database function/procedure investigation for Supabase-level errors
- [ ] Call stack tracing to identify exact origin of nested HTTPException
- [ ] Complete fix implementation once source is located
