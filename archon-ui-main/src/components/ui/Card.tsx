...
export const Card: React.FC<CardProps> = ({
  ...
  // Get accent color config with fallback to prevent undefined access
  const accentConfig = accentColorMap[accentColor] || accentColorMap.none;
  ...
  return <div className={`
        ...
        ${variantConfig} ${accentConfig.border}
        ...
        ${accentColor !== 'none' ? `
          ...
          ${accentConfig.line} ${accentConfig.glow}
          after:content-[""] after:absolute after:top-0 after:left-0 after:right-0 after:h-16
          after:bg-gradient-to-b ${accentConfig.gradientFrom} ${accentConfig.gradientTo}
